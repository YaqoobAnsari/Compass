...
of sight dominates the total error. A floor this indifferent to design indicates a missing
...
$2.86$~dB jointly where their separate gains predict $3.55$~dB, so a plain network
