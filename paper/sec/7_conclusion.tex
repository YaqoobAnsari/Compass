...
dominates the total. A plateau that indifferent to design is a statement about the
...
and moves the result past every method in the comparison, including in a plain
single network that has none of the architectural machinery its competitors carry.
Geometry and depth turn out to be substitutes rather than complements, and a third
...
That reframing sets the agenda we think is worth pursuing. Estimating propagation
direction from the measurements themselves, rather than assuming a known source or
discarding direction entirely, is the step that would make geometry conditioning
