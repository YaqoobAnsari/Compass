...
follows. The first is that geometry conditioning takes the cascade from $9.99$ to
...
line-of-sight error to $3.85$~dB and pulling non-line-of-sight error to $9.79$~dB.
Both sit below every member of the panel, and the single-network variant at $3.95$
and $10.72$~dB does the same. The channel costs $432$ parameters in the single
