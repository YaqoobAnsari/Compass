...
held-out cells. Adding one geometric channel to a single U-Net is worth more than
any architectural substitution in the panel.}
\label{tab:main}
\end{table}
...
transformer, adversarial and diffusion families. Non-line-of-sight error does not
...
and $10.73$~dB does the same. The channel costs $432$ parameters,
which is a $0.006\%$ increase over a $7.2$~million parameter backbone.
