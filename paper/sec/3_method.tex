...
\subsection{Backbones and Conditioning}

Separating the contribution of the channel from the contribution of capacity requires
two backbones of comparable size, one of which is the cascade RadioUNet itself uses.
The first is a single encoder-decoder network with $48$ base
